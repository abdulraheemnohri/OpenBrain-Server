...
# Initialize evolution engine for Self-Evolving Version
...
async def chat_completions(
    ...
    # Self-Evolving: Trigger task-pattern learning
    evo.learn_task_patterns(body.messages[-1]["content"], "error" not in result)
